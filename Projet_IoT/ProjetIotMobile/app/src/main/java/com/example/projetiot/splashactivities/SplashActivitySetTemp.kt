...
class SplashActivitySetTemp : AppCompatActivity() {

    private val SPLASH_TIMEOUT: Long = 3000

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.splash_screen_set_temp)
        ...
        handler.postDelayed({
            val mainIntent = Intent(this@SplashActivitySetTemp, MainAppActivity::class.java)
