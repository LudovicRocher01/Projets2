...
<head>
    ...
    <title>Cheque ISIWEB4SHOP</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      if(isset($_SESSION['admin']["username"])){
       ...
       <i class="bi-cart-fill me-1"></i>
		...
		<a href="Facture.php"><img src="images/cheque.png"  alt=\"logo cheque" /></a></br></br></br>
		<hr size="3"></br>            
		Veuillez envoyer un chèque du montant ci-dessus au nom de IsiWeb4SShop à l'adresse postale suivante :</br></br>
		15 Bd André Latarjet, 69100 Villeurbanne<br>
        ISIWEB4SHOP </br><br>
		Une fois le chèque encaissé, vous recevrez votre facture au format pdf et le colis sera envoyé dans les plus brefs délais
		</section>
