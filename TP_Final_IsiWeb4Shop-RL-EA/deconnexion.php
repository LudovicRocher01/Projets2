...
<head>
    ...
    <title>Votre Compte ISIWEB4SHOP</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      echo "<ul class='navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4'> <li>Votre Nom :<a class='badge bg-dark text-white ms-1 rounded-pill'> {$_SESSION["customer"]["surname"]} </a></li>";
      echo "<li>Votre Prénom :<a class='badge bg-dark text-white ms-1 rounded-pill'> {$_SESSION["customer"]["forname"]} </a></li>";
      echo "<li>Votre Adresse :<a class='badge bg-dark text-white ms-1 rounded-pill'> {$_SESSION["customer"]["add1"]} {$_SESSION["customer"]["add2"]} {$_SESSION["customer"]["postcode"]} , {$_SESSION["customer"]["add3"]} </a></li>";
      echo "<li>Votre Numéro de téléphone :<a class='badge bg-dark text-white ms-1 rounded-pill'> {$_SESSION["customer"]["phone"]} </a></li>";
      echo "<li>Votre Adresse Mail :<a class='badge bg-dark text-white ms-1 rounded-pill'> {$_SESSION["customer"]["email"]} </a></li></ul>";
      echo " <li> <br> </li>"
  ?>
  
  
 
<form name="deconnexion" method="post"><h1>
<input type="submit" name="DeConnexion" value="Deconnexion" /></h1></div>
</form>
<?php
